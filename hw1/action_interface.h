...
*/
bool check_action_0 (struct bank *boat_bank, struct bank *far_bank) {
...
/*
    ...
    missionaries because then they'll be eaten.
*/
bool check_action_1 (struct bank *boat_bank, struct bank *far_bank) {
...
*/
bool check_action_2 (struct bank *boat_bank, struct bank *far_bank) {
...
*/
bool check_action_4 (struct bank *boat_bank, struct bank *far_bank) {
...
bool check_action (int action, struct bank *boat_bank, struct bank *far_bank) {
  bool result = false;

  switch (action) {
    case 0:
      result = check_action_0(boat_bank, far_bank);
      break;
    case 1:
      result = check_action_1(boat_bank, far_bank);
      break;
    case 2:
      result = check_action_2(boat_bank, far_bank);
      break;
    case 3:
      result = check_action_3(boat_bank, far_bank);
      break;
    case 4:
      result = check_action_4(boat_bank, far_bank);
      break;
  }
